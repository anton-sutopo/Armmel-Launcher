...
public class GridLayout extends AdapterView<ApplicationAdapter> {
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    int childWidthMeasureSpec =
        MeasureSpec.makeMeasureSpec(widthSize / numColumns, MeasureSpec.EXACTLY);
    int childHeightMeasureSpec =
        MeasureSpec.makeMeasureSpec(heightSize / numRows, MeasureSpec.EXACTLY);
  ...
  private void populateViews() {
    ...
    for (int i = 0; i < adapter.getCount(); i++) {
      ...
      doubleClick.setDoubleClickListener(
            ...
            public boolean onLongClick(View v) {
              if (onItemLongClickListener != null) {
                return onItemLongClickListener.onItemLongClick(
                    GridLayout.this, v, position, position);
              }
              return false;
            }
          });
