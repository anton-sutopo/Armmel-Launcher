...
public class OutlineTextView extends View {
    ...
    public OutlineTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        text = "";
        if(attrs != null) {
            @SuppressLint("CustomViewStyleable") TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.StickerTextAttrs);
            textSize = a.getDimensionPixelSize(R.styleable.StickerTextAttrs_textSize, dpToPx(context,12));
