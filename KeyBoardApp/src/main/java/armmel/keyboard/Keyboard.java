...
/**
 * Loads an XML description of a keyboard and stores the attributes of the keys. A keyboard consists
 * of rows of keys.
 *
 * <p>The layout file for a keyboard contains XML that looks like the following snippet:
 *
 * <pre>
 * &lt;Keyboard
...
public class Keyboard {
  ...
  public static final int KEYCODE_JAVA = -7;
  ...
  public static class Row {
    ...
    public Row(Resources res, Keyboard parent, XmlResourceParser parser) {
      ...
      defaultHeight =
          getDimensionOrFraction(
              a, R.styleable.Keyboard_keyHeight, parent.mDisplayHeight, parent.mDefaultHeight);
  ...
  public static class Key {
    /**
     * All the key codes (unicode or custom code) that this key could generate, zero'th being the
     * most important.
     */
    public int[] codes;
    ...
    public Key(Resources res, Keyboard.Row parent, int x, int y, XmlResourceParser parser) {
      ...
      if (iconPreview != null) {
        iconPreview.setBounds(
            0, 0, iconPreview.getIntrinsicWidth(), iconPreview.getIntrinsicHeight());
      }
     ...
     *
     * <p>Toggled state of the key will be flipped when all the following conditions are fulfilled:
     *
     * <ul>
     *   <li>This is a sticky key, that is, {@link #sticky} is {@code true}.
     *   <li>The parameter {@code inside} is {@code true}.
     *   <li>{@link android.os.Build.VERSION#SDK_INT} is greater than {@link
  ...
  public boolean setJawa(boolean jawaState) {
    jawaKey.on = jawaState;
    return true;
  }
        ...
        if (event == XmlResourceParser.START_TAG) {
          ...
          if (TAG_ROW.equals(tag)) {
            ...
            if (key.codes[0] == KEYCODE_SHIFT) {
              ...
              mModifierKeys.add(key);
            } else if (key.codes[0] == KEYCODE_JAVA) {
              jawaKey = key;
              mModifierKeys.add(key);
            }
  ...
  private void parseKeyboardAttributes(Resources res, XmlResourceParser parser) {
    ...
    mDefaultWidth =
        getDimensionOrFraction(a, R.styleable.Keyboard_keyWidth, mDisplayWidth, mDisplayWidth / 10);
    mDefaultHeight = getDimensionOrFraction(a, R.styleable.Keyboard_keyHeight, mDisplayHeight, 50);
    mDefaultHorizontalGap =
        getDimensionOrFraction(a, R.styleable.Keyboard_horizontalGap, mDisplayWidth, 0);
    mDefaultVerticalGap =
        getDimensionOrFraction(a, R.styleable.Keyboard_verticalGap, mDisplayHeight, 0);
