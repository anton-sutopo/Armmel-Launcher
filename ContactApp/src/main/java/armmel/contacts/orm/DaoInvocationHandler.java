        ...
        if (method.isAnnotationPresent(Query.class)) {
            ...
            if (returnType == List.class && genericReturnType instanceof ParameterizedType) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    else if (elementType == Integer.class || elementType == int.class) results.add(cursor.getInt(0));
                    else if (elementType == Long.class || elementType == long.class) results.add(cursor.getLong(0));
            ...
            return db.update(tableName, values, idColumn + " = ?", new String[]{String.valueOf(idValue)});
        }
